...
class SoldTicketPininput extends StatefulWidget {
  const SoldTicketPininput({Key? key}) : super(key: key);

  @override
  State<SoldTicketPininput> createState() => _SoldTicketPininputState();
}

class _SoldTicketPininputState extends State<SoldTicketPininput> {
                    ...
                    onPressed: () async {
                      if (pinController.text == pinCode) {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => const SoldTickets()),
                        );
                      }
                    },
                  ),
